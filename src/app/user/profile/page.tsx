              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-md font-medium">{user.email}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">账户状态</p>
                    <p className={`mt-1 text-md font-medium ${user.is_active ? 'text-green-600' : 'text-red-600'}`}>
                      {user.is_active ? '已激活' : '未激活'}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">邮箱验证</p>
                    <p className={`mt-1 text-md font-medium ${user.is_verified ? 'text-green-600' : 'text-red-600'}`}>
